downloader = (function () {
  ...
  downloader.virtual_svg_rect = function (rgb_color, opacity, height, width, tr_x, tr_y) {
    var tagText =
      '<rect height="' + height + '" width="' + width + '" style="fill: ' + rgb_color + "; opacity: " + opacity + ';"></rect>';
  ...
  downloader.base64 = function (plain_text) {
    ...
    var base64 = window.btoa(
      encodeURIComponent(plain_text).replace(/%([0-9A-F]{2})/g, function (match, p1) {
